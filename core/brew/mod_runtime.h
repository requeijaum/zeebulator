...
class ModRuntime {
 ...
 private:
  ...
  void SwaplImpl(IArmCore& core);
  void SwapsImpl(IArmCore& core);
  void OEMStrLenImpl(IArmCore& core);
  void OEMStrSizeImpl(IArmCore& core);
  void MemchrImpl(IArmCore& core);
  void WstrncmpImpl(IArmCore& core);
  void WstrcpyImpl(IArmCore& core);
  void WstrcatImpl(IArmCore& core);
  void WstrcmpImpl(IArmCore& core);
  void WstricmpImpl(IArmCore& core);
  void WstrsizeImpl(IArmCore& core);
  void WstrdupImpl(IArmCore& core);
  void WstrlowerImpl(IArmCore& core);
  void WstrupperImpl(IArmCore& core);
  void StrnicmpImpl(IArmCore& core);
  void MemrchrImpl(IArmCore& core);
  void MemstrImpl(IArmCore& core);
  void AeeIsBadPtrImpl(IArmCore& core);
  void GetLastErrorImpl(IArmCore& core);
  void WstrlcpyImpl(IArmCore& core);
  void WstrlcatImpl(IArmCore& core);
  void StrbeginsImpl(IArmCore& core);
  void StrendsImpl(IArmCore& core);
  void StrchrendImpl(IArmCore& core);
  void AeeBasenameImpl(IArmCore& core);
  void GetFSFreeImpl(IArmCore& core);
  ...
  void StribeginsImpl(IArmCore& core);
  ...
  void StristrImpl(IArmCore& core);
